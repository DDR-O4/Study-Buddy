// module.exports = {
// 	name: 'my_doubt',
// 	aliases: ['md', 'mq', 'my_question'],
// 	permissions: [],
// 	description: 'Personalized doubts regarding anything!',
...
// 		// id of the category
// 		channel.setParent('862154787691823114');
...
module.exports = {
    ...
    async execute(message, args, cmd, client, Discord) {
        ...
        // id of the category
        channel.setParent('863720967578845204');
        ...
        const reactionEmbed = new Discord.MessageEmbed()
            ...
            .addFields(
                { name: '\u200B', value: '\u200B' },
                { name: 'For Academic related doubts', value: 'Tag <@&863254865543036948>', inline: true },
                { name: 'For Exam \nrelated doubts', value: 'Tag <@&863255674855358477>', inline: true },
                { name: 'For Office \nrelated doubts', value: 'Tag <@!863255295568379956>', inline: true },
            )
            .setFooter('Study Buddy here to help!', 'https://i.imgur.com/Eey6gzU.png');
